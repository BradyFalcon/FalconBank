...
declare module 'child_process' {
    ...
    class ChildProcess extends EventEmitter {
         ...
         *
         * While the example above uses a server created using the `net` module, `dgram`module servers use exactly the same workflow with the com.revature.exceptions of listening on
