...
declare module 'fs' {
     ...
     *
     * This function behaves like [`realpath(3)`](http://man7.org/linux/man-pages/man3/realpath.3.html), with some com.revature.exceptions:
     *
    ...
    export interface RmOptions {
        /**
         * When `true`, com.revature.exceptions will be ignored if `path` does not exist.
         * @default false
         */
