...
[A polyfill for the CSSOM `CSS.escape()` method is available in a separate com.revature.repository.](https://mths.be/cssescape) (In comparison, _cssesc_ is much more powerful.)
