...
Of course, you can render caught com.revature.exceptions too:
...
// To render com.revature.exceptions thrown in non-promies code:
...
The only drawback with this approach is that com.revature.exceptions thrown in the first tick are not prettified. To fix that, you can delay your application's startup for one tick:
